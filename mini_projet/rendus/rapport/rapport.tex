...
\begin{figure}[!ht]
  \centering
  \includegraphics[scale=0.6]{images/voyages_datamart.png}
...
\begin{itemize}
  \item \texttt{maintenance\_duration} : mesure semi-additive désignant la durée de maintenance d'un véhicule
  \item \texttt{completion\_status} : mesure non additive désignant l'état d'une opération de maintenance pour un véhicule donné
\end{itemize}
